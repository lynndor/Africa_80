                ...
                <div className="row">
                    ...
                    <div className="col-lg-8">
                        <form className="form-contact contact_form" action="contact_process.php" method="post" id="contactForm"
                            ...
                            <div className="form-group mt-2 mb-5 mb-lg-0">
                                <button type="submit" className="button button-contactForm primary-btn">Send Message</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div className="col-lg-4">
                        <div className="media contact-info">
                            <span className="contact-info__icon"><i className="fa fa-home"></i></span>
                        ...
                        <div className="media contact-info">
                            <span className="contact-info__icon"><i className="fa fa-phone"></i></span>
                            <div className="media-body">
                        ...
                        <div className="media contact-info">
                            <span className="contact-info__icon"><i className="fa fa-envelope-o"></i></span>
                            <div className="media-body">
